...
extern int addInstruction(
      t_translation_infos *infos, t_asm_instruction *instruction);
...
extern t_asm_label *findLabel(
      t_translation_infos *infos, char *ID, int *asm_errorcode);
